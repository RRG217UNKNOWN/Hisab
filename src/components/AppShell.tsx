...
export function AppShell({
  ...
  const ALL_NAV: {
    ...
    { key: "parties", label: t("nav.parties"), to: "/parties", icon: <Contact size={17} />, show: can.viewVendors(role) },
    { key: "expenses", label: t("nav.expenses"), to: "/expenses", icon: <Wallet size={17} />, show: can.viewExpenses(role) },
    { key: "createBill", label: t("nav.createBill"), to: "/create-bill", icon: <FileText size={17} />, show: can.viewCreateBill(role) },
    { key: "import", label: t("nav.import"), to: "/import", icon: <Upload size={17} />, show: can.viewImport(role) },
    { key: "export", label: t("nav.export"), to: "/export", icon: <Download size={17} />, show: can.viewExport(role) },
    ...
    { key: "connections", label: t("nav.connections"), to: "/connections", icon: <Network size={17} />, show: can.manageConnections(role) },
    { key: "requests", label: t("nav.requests"), to: "/requests", icon: <Send size={17} />, show: can.manageConnections(role) || can.fulfillRequests(role) },
  ...
  const PINNED_LAST: NavKey[] = ["account", "settings"];
