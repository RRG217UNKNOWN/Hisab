  ...
  public: {
    Tables: {
      ...
      expense_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_items_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      transaction_classifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaction_classifications_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      party_opening_balances: {
        ...
        Relationships: [
          {
            foreignKeyName: "party_opening_balances_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      profiles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "profiles_role_group_id_fkey"
      ...
      role_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_groups_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      role_group_permissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "role_group_permissions_role_group_id_fkey"
            columns: ["role_group_id"]
            isOneToOne: false
            referencedRelation: "role_groups"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      effective_tab_permissions: { Args: Record<PropertyKey, never>; Returns: { tab_key: string; can_view: boolean }[] }
      verify_org_code: {
        Args: { _code: string }
        Returns: {
          id: string
