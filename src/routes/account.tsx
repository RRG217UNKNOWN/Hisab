...
import { z } from "zod";
import { LogOut, User as UserIcon, Copy, Check, Building2, Receipt, Network, ChevronRight } from "lucide-react";
...
function SignedInView({ userId, email }: { userId: string; email: string }) {
  ...
  return (
    <div className="space-y-5">
      ...
      {can.manageConnections(profile?.role) && (
            ...
            <div className="flex items-center gap-2 text-sm text-ink">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  Connect with partner orgs to send and receive cross-org requests.
                </p>
              </div>
            </div>
