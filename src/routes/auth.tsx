  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "signup") {
        ...
        // If session immediately (auto-confirm), attach org
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card-warm p-6 space-y-5">
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            {mode === "signup" && (
              <div className="rounded-lg border border-border bg-muted/40 p-3 space-y-3">
                <div className="text-xs font-medium text-ink">Organization</div>
                ...
                {orgMode === "solo" && (
                  <p className="text-xs text-muted-foreground">
                    You'll be the owner of your own private workspace. You can invite teammates later.
                  </p>
                )}
              </div>
            )}
          ...
          <div className="flex items-start gap-2 text-xs text-muted-foreground">
            ...
            <span>
              Each shop's data is fully isolated. Only members of your organization can see or edit your records.
            </span>
          </div>
        </div>
      </div>
