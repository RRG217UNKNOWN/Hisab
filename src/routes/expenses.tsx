...
import { Plus, Repeat, X, Trash2, Store, Wallet, BookOpen, Search, Check, Pencil } from "lucide-react";
        ...
        <header className="flex flex-wrap items-end justify-between gap-4">
          ...
          {canWrite && (
            <div className="flex items-center gap-2">
              ...
              >
                <BookOpen size={14} /> {t("exp.chartOfAccounts")}
              </button>
              <button
...
// ---------------------------------------------------------------------------
// Chart of Accounts manager — the master list itself. Lets an owner/manager
// browse, search, rename, re-categorize, add, and remove standardized
// expense items outside the flow of logging a single expense.
// ---------------------------------------------------------------------------
function ExpenseItemsManager({
  userId,
  items,
  onClose,
  onChanged,
