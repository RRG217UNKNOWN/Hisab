...
// parsed inventory entries). Previously imported from voice-entry.functions.ts
// (a TanStack Start server function calling Lovable's AI Gateway) — that file
// is gone now that transcription/parsing runs in a Supabase Edge Function.
    ...
    try {
      ...
      rec.onstop = async () => {
        ...
        try {
          ...
          const result = data as { transcript: string; items: ParsedItem[] };
