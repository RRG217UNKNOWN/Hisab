...
function SettingsPage() {
  ...
  const { enabled: colorblind, setEnabled: setColorblind } = useColorblindMode();
            ...
            <div className="card-warm p-5 md:p-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2 text-sm text-ink">
                  ...
                  <div>
                    <div className="font-medium">{t("set.colorblindTitle")}</div>
                    <p className="mt-0.5 text-xs text-muted-foreground">{t("set.colorblindHint")}</p>
                  </div>
                </div>
                <button
                  role="switch"
                  ...
                  className={`relative h-6 w-11 shrink-0 rounded-full transition ${
                    colorblind ? "bg-primary" : "bg-muted"
                  }`}
                >
                  <span
